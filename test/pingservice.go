...
import (
	...
	pb_testproto "github.com/tsingsun/woocoo/test/testproto"
...
type TestPingService struct {
	T *testing.T
	pb_testproto.UnimplementedTestServiceServer
}
...
func (s *TestPingService) PingPanic(ctx context.Context, ping *pb_testproto.PingRequest) (*pb_testproto.Empty, error) {
