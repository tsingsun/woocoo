...
type TestServiceClient interface {
	...
	PingPanic(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*Empty, error)
...
func (c *testServiceClient) PingPanic(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/TestService/PingPanic", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TestServiceServer interface {
	...
	PingPanic(context.Context, *PingRequest) (*Empty, error)
...
func (UnimplementedTestServiceServer) PingPanic(context.Context, *PingRequest) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PingPanic not implemented")
}
...
func _TestService_PingPanic_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TestServiceServer).PingPanic(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/TestService/PingPanic",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestServiceServer).PingPanic(ctx, req.(*PingRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TestService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PingPanic",
			Handler:    _TestService_PingPanic_Handler,
		},
	},
